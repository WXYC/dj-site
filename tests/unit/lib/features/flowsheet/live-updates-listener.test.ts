...
// The listener uses two entry points: sse_* analytics events go straight to
// PostHog, while dispatch/parse failures go through the error-reporting facade
// (which fans out to both sinks).
vi.mock("@/lib/posthog", () => ({
