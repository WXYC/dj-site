...
describe("rotation list page", () => {
  ...
  it("redirects a DJ away", async () => {
    ...
    await expect(RotationListPage()).rejects.toThrow("NEXT_REDIRECT:/dashboard");
  ...
  it("404s before any session read when the rotation admin flag is off", async () => {
    ...
    await expect(RotationListPage()).rejects.toThrow("NEXT_NOT_FOUND");
