...
vi.mock("@/src/components/experiences/modern/Leftbar/LeftbarContainer", () => ({
  default: ({ children }: { children: React.ReactNode }) => (
    <div data-testid="leftbar-container">{children}</div>
  ),
}));

vi.mock("@/src/components/experiences/modern/Leftbar/LeftbarLink", () => ({
  default: ({
    path,
    title,
    disabled,
...
vi.mock("@/src/components/experiences/modern/Leftbar/FlowsheetLink", () => ({
  default: () => <div data-testid="flowsheet-link">Flowsheet</div>,
}));

vi.mock("@/src/components/experiences/modern/Leftbar/LeftbarSettingsButton", () => ({
  default: () => (
...
vi.mock("@/src/components/experiences/modern/Leftbar/LeftbarLogout", () => ({
