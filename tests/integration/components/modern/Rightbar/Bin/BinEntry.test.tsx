...
vi.mock("@/src/components/experiences/modern/Rightbar/Bin/useBinEntryActions", () => ({
...
vi.mock("@/src/components/experiences/modern/Rightbar/Bin/BinEntryActions", () => ({
  default: ({ actions }: any) => (
    <div data-testid="bin-actions">{actions.length}</div>
  ),
}));

vi.mock("@/src/components/experiences/modern/Rightbar/Bin/BinEntryContextMenu", () => ({
  default: ({ anchor }: any) => (
