...
vi.mock("@/src/components/experiences/modern/flowsheet/Entries/SongEntry/SongEntry", () => ({
...
vi.mock("@/src/components/experiences/modern/flowsheet/Entries/MessageEntry", () => ({
  default: ({
    children,
    startDecorator,
    endDecorator,
...
vi.mock("@/src/components/experiences/modern/flowsheet/Entries/Components/DateTimeStack", () => ({
