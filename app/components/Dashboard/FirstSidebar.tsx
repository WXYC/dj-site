  ...
  return (
    ...
    >
      ...
      <List sx={{ "--ListItem-radius": "8px", "--List-gap": "12px" }}>
        ...
        <Link href="/dashboard/flowsheet" onClick={(e) => e.preventDefault()}>
          <ListItem>
            <Tooltip
              title="Flow Sheet"
              arrow={true}
            ...
            >
              <ListItemButton
                disabled
                variant={
                  pathname === "/dashboard/flowsheet" ? "solid" : "plain"
                }
              >
                <Badge
                  anchorOrigin={{
        ...
        <Link href="/dashboard/playlists" onClick={(e) => e.preventDefault()}>
          <ListItem>
            <Tooltip
              title="Previous Sets"
              arrow={true}
            ...
            >
              <ListItemButton
                disabled
                variant={
                  pathname.includes("/dashboard/playlists") ? "solid" : "plain"
                }
              >
                <StorageIcon />
              </ListItemButton>
      ...
      >
        ...
        >
          {hovering ? <LogoutOutlinedIcon /> : <PersonOutlinedIcon />}
        </IconButton>
      </Tooltip>
    </Sheet>
  );
