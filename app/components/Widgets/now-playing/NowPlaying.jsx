...
const NowPlaying = (props) => {
  ...
  const [imageUrl, setImageUrl] = React.useState(`${prefix}/cassette.png`);
  ...
  const getImage = async (artist, album, default_return = "") => {
    ...
    let storedArtwork = sessionStorage.getItem(`img-${album}-${artist}`);
    ...
    try {
      ...
      sessionStorage.setItem(`img-${album}-${artist}`, retrievedArtwork);
      return retrievedArtwork;
    } catch (e) {
      sessionStorage.setItem(`img-${album}-${artist}`, default_return);
    ...
    <>
      ...
      {props.mini ? (
        ...
        >
          ...
          {isSong ? (
            ...
            >
              ...
              <Stack direction="row">
                <Typography
                  level="body-md"
                  sx={{ mt: 0.5, whiteSpace: "nowrap", overflow: "hidden" }}
                  color="primary"
                  ref={lowerText}
                >
                  {lowerTextMarquee ? (
          ...
          <CardOverflow
            variant={message.includes("End of Show") ? "solid" : "soft"}
            color={message.includes("End of Show") ? "neutral" : "primary"}
          >
