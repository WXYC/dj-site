...
const CatalogSearchTable = (): JSX.Element => {
  ...
  const getSongCardFor = (item: CatalogResult | undefined) =>
    dispatch(
      applicationSlice.actions.openSideBar(<SongCard songCardContent={item} />)
    );
                ...
                <tr key={row.id}>
                    ...
                    <Box sx={{ display: "flex", gap: 2, alignItems: "center" }}>
                      <div>
                        ...
                        <Typography level="body-sm">
                          {row.album.alternate_artist?.name}
                        </Typography>
                      </div>
                    </Box>
                  </td>
                  ...
                  <td>
                    ...
                    <Typography level="body-md">
                      {row.album.artist.lettercode}{" "}
                      {row.album.artist.numbercode}/{row.album.release}
                    </Typography>
                  </td>
                  <td>
                    <Chip
                      ...
                      size="sm"
                      color={
                        row.album.format.includes("Vinyl")
                          ? "primary"
                          : "warning"
                      }
                    >
