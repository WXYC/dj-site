...
export default function LoginPage(): JSX.Element {
    ...
    const randomIndexForWelcomeQuote = (Math.floor(Math.random() * welcomeQuotesAndArtists.length));
    const randomIndexForHoldOnQuote = (Math.floor(Math.random() * holdOnQuotesAndArtists.length));
