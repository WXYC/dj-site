...
const ClassicCatalogPage = () => {
  ...
  const setSearchString = (value: string) =>
    dispatch(catalogSlice.actions.setQuery(value));
  const genre = useSelector(getGenre);
  const setGenre = (value: Genre) =>
    dispatch(catalogSlice.actions.setGenre(value));
  const searchIn = useSelector(getSearchIn);
  const setSearchIn = (value: SearchInOption) =>
    dispatch(catalogSlice.actions.setSearchIn(value));
  const releaseList = useSelector(getResults);
  const orderBy = useSelector(getOrderBy);
  const handleRequestSort = (value: OrderByOption) =>
    dispatch(catalogSlice.actions.setOrderBy(value));
  const orderDirection = useSelector(getOrderDirection);
  const setOrderDirection = (value: OrderDirectionOption) =>
    dispatch(catalogSlice.actions.setOrderDirection(value));
  ...
  if (openResults || searchString.length > 0) {
    return (
      <div style={{ position: "relative" }}>
        <div id="adminLogin">
          <b>Welcome, {user?.name ?? `DJ ${user?.djName}`}</b>
          <br />
          <b>
            <LogoutClassic />
          </b>
        ...
        <form name="searchForm" onSubmit={handleSubmit}>
          ...
          <div id="searchButton">
            <input type="submit" value="Search WXYC Library!" />
          </div>
          <div id="sortbyRelevance">
            <b>
              <a
                href="searchCardCatalog"
                onClick={(e) => {
                  e.preventDefault();
        ...
        <div id="facetLinks">
          ...
          <li>
            <a
              style={{
                fontWeight:
                  genre == "Unknown" || genre == "All" ? "bold" : "initial",
              }}
              href="#"
              onClick={() => setGenre("Unknown")}
            >
              Any
            </a>
          </li>
          ...
          <li>
            <a
              style={{ fontWeight: genre == "Blues" ? "bold" : "initial" }}
              href="#"
          ...
          <li>
            <a
              style={{ fontWeight: genre == "Electronic" ? "bold" : "initial" }}
              href="#"
          ...
          <li>
            <a
              style={{ fontWeight: genre == "Hiphop" ? "bold" : "initial" }}
              href="#"
          ...
          <li>
            <a
              style={{ fontWeight: genre == "Jazz" ? "bold" : "initial" }}
              href="#"
          ...
          <li>
            <a
              style={{ fontWeight: genre == "OCS" ? "bold" : "initial" }}
              href="#"
              onClick={() => setGenre("OCS")}
            >
              OCS
            </a>
          </li>
          ...
          <li>
            <a
              style={{ fontWeight: genre == "Rock" ? "bold" : "initial" }}
              href="#"
          ...
          <li>
            <a
              style={{
                fontWeight: genre == "Soundtracks" ? "bold" : "initial",
              }}
              href="#"
              onClick={() => setGenre("Soundtracks")}
            >
              Soundtracks
            </a>
          </li>
          ...
          <li>
            <a href="#" onClick={() => console.log("cd")}>
              cd
            </a>
          </li>

          <li>
            <a href="#" onClick={() => console.log("vinyl")}>
              vinyl
            </a>
          </li>
        </div>
        ...
        <div id="searchResultsPanel">
          <p></p>
          &nbsp;&nbsp;Displaying <b>{releaseList.length}</b> results matching
          text query <b>{searchString}</b>
          <p></p>
          &nbsp;&nbsp;
          {!reachedEndForQuery && (
          ...
          >
            <tr className="searchResultsHeader">
              ...
              <th align="center" style={{ width: "10%" }} className="label">
                Format
              </th>
            </tr>
            {releaseList.map((row) => (
              <tr style={{ background: "#F3F3F3" }}>
                ...
                <td className="text" align="left">
                  {row.album.artist.lettercode} {row.album.artist.numbercode}/
                  {row.album.release}
                </td>
                <td className="text">
                  <a href="artist?id=9465&amp;mode=view">
                    {row.album.artist.name}
                  </a>
                </td>
                <td className="text">
                  <a href="libraryRelease?id=25674">{row.album.title}</a>
                </td>
