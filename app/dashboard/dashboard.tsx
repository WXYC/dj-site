'use client';
import { getAuthenticatedUser, getClassicViewAvailable, getIsLive, useDispatch, useSelector } from "@/lib/redux";
...
export default function DashboardContent(props: React.PropsWithChildren): JSX.Element {
