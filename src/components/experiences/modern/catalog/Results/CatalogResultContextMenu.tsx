...
// Right-click menu on a result row; the results list owns the state, so one menu opens at a time and closing unmounts it.
...
// MD-only rotation section; mounts inside RequireMD so the rotation subscription only runs for an authorized viewer.
