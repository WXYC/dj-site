...
app/                          # Next.js App Router pages
  dashboard/                  # Authenticated views
    ...
    @information/             # Reserved parallel slot (catalog modals render from @modern layout)
  login/                      # Login page
...
### Catalog entry modals (modern)

Catalog view/edit/add use Joy modals mounted from `CatalogPathModals` in `app/dashboard/@modern/layout.tsx` (pathname-driven). The `@information` parallel slot is reserved; do not put catalog card UI in the rightbar.

| Action | Permalink | Modal `data-testid` |
|--------|-----------|---------------------|
| View | `/dashboard/catalog/album/:id` | `album-detail-modal` |
| Edit | `/dashboard/catalog/album/:id/edit` | `catalog-edit-modal` |
| Add | `/dashboard/catalog/new` | `catalog-add-modal` |
