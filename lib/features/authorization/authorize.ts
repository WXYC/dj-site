...
import { BetterAuthSession, BetterAuthSessionResponse } from "@/lib/features/authentication/utilities";
...
/**
 * Convenience function for Admin routes.
 */
export async function requireAdmin(
  request: NextRequest
): Promise<AuthorizeResult<Authorization.ADMIN>> {
  return authorize(request, { role: Authorization.ADMIN });
}
